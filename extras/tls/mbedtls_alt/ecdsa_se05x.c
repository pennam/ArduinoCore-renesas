    ...
    void *p_rng)
{
    ...
    /* KeyId 100 is used for ArduinoIoTCloud authentication and needs SHA384 */
    SE05x_ECSignatureAlgo_t ecSignAlgo = ( keyID == 100 ) ? kSE05x_ECSignatureAlgo_SHA_384 : kSE05x_ECSignatureAlgo_SHA_256;
